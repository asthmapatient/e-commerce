  ...
  return (
    <div className="bg-[#1E2832] bg-opacity-5 xl:px-28 px-4 py-16">
      ...
      <div className="flex flex-wrap gap-4 items-center justify-center mb-20">
        <a href="">
          <img src="img/images/instagram/img1.png" alt="" />
        </a>
        <a href="">
          <img src="img/images/instagram/img2.png" alt="" />
        </a>
        <a href="">
          <img src="img/images/instagram/img3.png" alt="" />
        </a>
        <a href="">
          <img src="img/images/instagram/img4.png" alt="" />
        </a>
        <a href="">
          <img src="img/images/instagram/img5.png" alt="" />
        </a>
        <a href="">
          <img src="img/images/instagram/img6.png" alt="" />
        </a>
      </div>
